...
class PollIndexDetailTests(TestCase):
    def test_detail_view_with_a_future_poll(self):
        """
        The detail view of poll with a pub_date in the future should
...
class PollIndexResultsTests(TestCase):
    ...
    def test_results_view_with_no_questions(self):
        """
        The results view of a poll with no questions should returna 404
        not found.
        """
